...
** Сравнения:
Сравнение - это функция, которая принимает две строки и возвращает булево значение - равны ли эти строки.
...
** Объединение условий:
Объединение условий - это функция, которая принимает два булевых значения и возвращает булево
